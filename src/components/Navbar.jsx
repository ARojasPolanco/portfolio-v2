...
const Navbar = () => {
    ...
    return (
        <section>
            ...
            <section className={`bg-bg-200/10 z-10 backdrop-blur-sm w-full p-2 fixed bottom-0 flex justify-between items-center min-[640px]:flex-col min-[640px]:top-0 min-[640px]:w-[50px] min-[640px]:rounded-full min-[640px]:my-auto min-[640px]:h-[250px] ${showMenu ? 'min-[640px]:right-4' : 'min-[640px]:-right-full'} transition-all duration-300`}>
