import img3 from '/images/donando.png'
            ...
            <div
                ...
                <article className=' border-2 border-white/50 rounded-xl overflow-hidden max-w-[450px]'>
                    <div className='group relative overflow-hidden'>
                        ...
                        <div className='text-white text-lg absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>Donando</div>
                    </div>
                    <article className='flex gap-x-12 justify-center p-1'>
                        <article className='text-black dark:text-white flex justify-center items-center gap-x-2 w-[100px] hover:bg-bg-100 hover:text-white'>
                            ...
                            <a href="https://github.com/Jerebrrs/back-no-country-c18-03--m-node" target="_blank">GitHub</a>
                        </article>
                        <article className='flex justify-center items-center gap-x-2 text-netlify w-[100px] hover:bg-bg-100'>
                            ...
                            <a className="text-black dark:text-white hover:text-white" href="https://donando.vercel.app/" target="_blank">Netlify</a>
                        </article>
                    </article>
                </article>
                <article className=' border-2 border-white/50 rounded-xl overflow-hidden max-w-[450px]'>
